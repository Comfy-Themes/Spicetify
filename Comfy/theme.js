...
async function initComfy() {
  ...
  const Content = () => {
    ...
    Spicetify.React.useEffect(() => {
      fetch(
        `https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/${Spicetify.Config?.color_scheme.toLowerCase()}.css`
      )
        .then((res) => {
    ...
    return Spicetify.React.createElement(
      ...
      Spicetify.React.createElement(Section, { name: "Support Modules", condition: !!libX }, [
        {
          ...
          defaultVal: true,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/libx.css",
        },
        {
          type: "slider",
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/topbar-in-titlebar.css",
        },
      ]),
      Spicetify.React.createElement(Section, { name: "Interface" }, [
        ...
        },
        {
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/remove-device-picker.css",
        },
        {
          type: "slider",
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/no-progressBar-gradient.css",
        },
        {
          type: "slider",
          ...
          defaultVal: true,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/home-header.css",
        },
        {
          type: "slider",
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/remove-timers.css",
        },
        {
          type: "slider",
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/remove-lyrics-button.css",
        },
      ]),
      Spicetify.React.createElement(Section, { name: "Cover Art" }, [
        {
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/oblong-nowPlayingArt.css",
        },
        {
          type: "slider",
          ...
          url: `https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/${Spicetify.Config?.color_scheme.toLowerCase()}.css`,
        },
        {
          type: "slider",
          ...
          defaultVal: false,
          url: "https://raw.githubusercontent.com/Comfy-Themes/Spicetify/legacy/Comfy/snippets/revert-right-art.css",
        },
      ]),
